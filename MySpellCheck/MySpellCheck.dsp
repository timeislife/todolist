...
# ADD CPP /nologo /MTd /W4 /Gm /GX /Zi /Od /D "_DEBUG" /D "_UNICODE" /D "UNICODE" /D "_USRDLL" /D "MYSPELLCHECK_EXPORTS" /D "_EXPORTING" /D "WIN32" /D "_WINDOWS" /D "_MBCS" /FD /GZ /c
# SUBTRACT CPP /Fr
...
# ADD CPP /nologo /MT /W4 /GX /Zi /O1 /D "_USRDLL" /D "MYSPELLCHECK_EXPORTS" /D "_EXPORTING" /D "WIN32" /D "NDEBUG" /D "_WINDOWS" /D "_MBCS" /D "_UNICODE" /D "UNICODE" /FD /c
# SUBTRACT CPP /Gy /Fr
