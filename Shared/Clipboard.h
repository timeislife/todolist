...
static UINT CF_HTML = ::RegisterClipboardFormat(_T("HTML Format"));
...
public:
	...
	static CString& PackageContent(CString& sContent, UINT nFormat);
	static CString& UnpackageContent(CString& sContent, UINT nFormat);
