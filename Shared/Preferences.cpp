...
void CPreferences::WriteProfileArray(LPCTSTR lpszSection, const CStringArray& aItems)
{
...
// THIS IS AN INTERNAL METHOD THAT ASSUMES CALLERS HAVE INITIALISED A LOCK ALREADY
CString CPreferences::GetEntryValue(const INISECTION& section, LPCTSTR lpszEntry, LPCTSTR lpszDefault)
{
	ASSERT(s_bIni);
	ASSERT(s_bLocked);
