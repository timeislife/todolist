...
public:
	...
	void WriteProfileArray(LPCTSTR lpszSection, const CStringArray& aItems);
...
protected:
	...
	static CString GetEntryValue(const INISECTION& section, LPCTSTR lpszEntry, LPCTSTR lpszDefault);
