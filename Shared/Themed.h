...
{
    TH_BPBF_COMPATIBLEBITMAP,    // Compatible bitmap
	TH_BPBF_DIB,                 // Device-independent bitmap
	TH_BPBF_TOPDOWNDIB,          // Top-down device-independent bitmap
	TH_BPBF_TOPDOWNMONODIB       // Top-down monochrome device-independent bitmap
};
