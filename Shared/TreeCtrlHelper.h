...
public:
	...
	HTREEITEM FindWidestItem(int& nWidth, BOOL bExpandedOnly = FALSE) const;
	HTREEITEM FindWidestItem(BOOL bExpandedOnly = FALSE) const;
...
protected:
	...
	HTREEITEM FindWidestItem(HTREEITEM htiParent, int& nWidth, BOOL bExpandedOnly) const;
