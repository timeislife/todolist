...
BOOL CPreferencesTaskDefPage::GetListIsReadonly(PTDP_LIST nList) const
{
	switch (nList)
	{
	case PTDP_ALLOCBY:	return m_bAllocByListReadonly;
	case PTDP_ALLOCTO:	return m_bAllocToListReadonly;
	case PTDP_STATUS:	return m_bStatusListReadonly; 
	case PTDP_CATEGORY:	return m_bCatListReadonly;
	}
