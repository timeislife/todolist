...
protected:
	BOOL ImportTask(ITaskList13* pTasks, const CString& sLine) const;
	...
	void AddAttributeToTask(ITaskList13* pTasks, HTASKITEM hTask, TDC_ATTRIBUTE nAttrib, const CStringArray& aValues) const;
	void AddCustomAttributesToTask(ITaskList13* pTasks, HTASKITEM hTask, const CStringArray& aValues) const;
	void AddCustomAttributes(ITaskList13* pTasks) const;
